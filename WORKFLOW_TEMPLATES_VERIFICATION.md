...
Bei Problemen:
- Siehe: WORKFLOW_TEMPLATES_ORGANIZATION_GUIDE.md
- Siehe: IMPLEMENTATION_REPORT_ADR011.md
- GitHub Docs: https://docs.github.com/en/actions/using-workflows/creating-starter-workflows-for-your-organization
